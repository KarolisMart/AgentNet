...
from smp_models.utils.layers import XtoX, UtoU, UtoU, EntrywiseU, EntryWiseX
...
class SMPLayer(MessagePassing):
    ...
    def reset_parameters(self):
        self.message_nn.reset_parameters()
        self.order2_i.reset_parameters()
        self.order2_j.reset_parameters()
        self.order2.reset_parameters()
